...
def get_args():
    ...
    parser.add_argument("--checkpoint", type=str, default="https://github.com/shawarmabytes/CoE-197Z-Deep-Learning/releases/download/v2.0/shawarmabytes-kws-best-acc.pt")
...
if __name__ == "__main__":
    ...
    if not args.gui:
        ...
        print("dumadaan siya dito")
        mel = rearrange(mel, "c h (p1 w) -> p1 (c h w)", p1=16)
        mel = mel.unsqueeze(0)
